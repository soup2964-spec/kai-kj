      ...
      <div className="mx-auto flex flex-col gap-y-10 gap-x-16 md:flex-row md:items-center md:justify-between lg:gap-x-20">
        <div className="max-lg:w-full max-lg:max-w-[629px]">
          <div className="flex max-w-[356px] flex-col max-lg:pl-4">
            ...
            <p className="mt-3 max-w-[441px] leading-[145%] tracking-[-0.01em] text-[#646E87]">
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex h-[37px] items-center rounded-[43px] border border-[#939db833] bg-[#171926] px-3 text-[13px] text-[#89CFF0] transition hover:text-white"
              >
                Explore pricing
            ...
            <div className="mt-10 flex gap-x-14 md:gap-x-16">
              <div className="flex flex-col gap-y-1">
                <p className="text-[13px] leading-[145%] text-[#646E87]">Ingest up to</p>
                <p className="text-[28px] font-bold leading-[117%] text-[#363D4E]">80x more data</p>
                <p className="text-[13px] leading-[145%] text-[#646E87]">with the same budget</p>
              </div>
              <div className="flex flex-col gap-y-1">
                <p className="text-[13px] leading-[145%] text-[#646E87]">or save up to</p>
                <p className="text-[28px] font-bold leading-[117%] text-[#363D4E]">98%</p>
                <p className="text-[13px] leading-[145%] text-[#646E87]">of your costs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full flex-1 rounded-[26px] border border-[#939db81a] p-4 md:max-w-[641px] md:min-w-[540px] xl:min-w-[641px]">
          ...
          <div className="flex flex-col rounded-b-xl border border-t-0 border-[#939db81a] bg-[#0F101A] px-6">
            ...
            <div className="flex flex-col gap-y-4 py-6 md:flex-row md:items-center">
              <div className="flex w-[247px] items-center gap-x-2">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-r from-[#B8E6FF] to-[#5EB8E8]">
              ...
              <div className="w-full">
                <div className="h-[13px] w-[13px] rounded-[200px] bg-gradient-to-r from-[#B8E6FF] to-[#5EB8E8]" />
                <p className="mt-2 text-base leading-[145%] tracking-[-0.14px] text-neutral-200">
      ...
      <div className="container mx-auto -mt-[25%] max-w-[1000px] sm:-mt-24 md:mt-0">
        <div className="mt-14 md:mt-0 md:max-w-[350px] lg:max-w-none">
          <div className="text-center md:text-left">
            <h2 className="font-helveticaDisplay mx-auto max-w-[500px] text-[24px] font-bold leading-[117%] text-[#363D4E] md:mx-0 lg:text-[36px]">
          ...
          <div className="mt-10 w-full sm:w-auto">
            ...
            <p className="mt-5 pb-2 text-center text-[13px] text-[#646E87] sm:text-base lg:ml-2 lg:text-left">
              Start monitoring for free or{" "}
              <a
                href="https://betterstack.com/book-a-demo"
                className="text-[#363D4E] underline decoration-[#5EB8E8]/30 underline-offset-4 transition hover:decoration-[#5EB8E8]"
